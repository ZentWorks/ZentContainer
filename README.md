...
- Container groups across one or multiple Docker hosts with aggregated live CPU/RAM/network throughput, group-level update highlighting and direct cleanup of members whose containers no longer exist
